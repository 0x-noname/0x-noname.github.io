...
excerpt: "Pwned es una máquina Linux de nivel Fácil creada por Annlynn, con wfuzz encontraremos las credenciales de acceso al FTP, una vez en el FTP nos descargaremos un
fichero id_rsa para conectarnos a la máquina. Después tendremos que hacer un user pivoting usando un archivo en bash y finalmente escalaremos privilegios mediante un exploit."
date: 2021-09-20
classes: wide
header:
